...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun setupInput() {
        ...
        findViewById<SwitchMaterial>(R.id.settings_theme_button).apply {
            isChecked = AppCompatDelegate.getDefaultNightMode().equals(AppCompatDelegate.MODE_NIGHT_YES)
            ...
            setOnClickListener {
                val theme = if (!isChecked) AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM else AppCompatDelegate.MODE_NIGHT_YES
